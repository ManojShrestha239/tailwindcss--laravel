    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ route('dashboard') }}">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden" src="{{ asset('vendor/images/logo/logo.svg') }}" alt="Logo" />
                <img class="hidden dark:block" src="{{ asset('vendor/images/logo/logo-dark.svg') }}" alt="Logo" />
            </span>

            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src="{{ asset('vendor//images/logo/logo-icon.svg') }}" alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                <li>
                                    <a href="{{ route('baseTable') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('404') }}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('maintenance') }}" class="menu-dropdown-item group"
                                        :class="page === 'maintenance' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Maintenance
                                    </a>
                                </li>
