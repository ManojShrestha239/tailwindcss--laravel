...
<body x-data="{ page: 'maintenance', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
    ...
    <div class="relative z-1 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
        ...
        <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
            ...
            <img src="{{ asset('vendor/images/error/maintenance.svg') }}" alt="maintenance" class="dark:hidden" />
            <img src="{{ asset('vendor/images/error/maintenance-dark.svg') }}" alt="maintenance"
        ...
        <p class="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-sm text-gray-500 dark:text-gray-400">
            &copy; <span id="year"></span> - {{ env('APP_NAME') }}
        </p>
    </div>
